const locale = {
  ...
  'editor.ai.tooltip': 'Trợ lý AI',
  'editor.ai.editSelection': 'Chỉnh sửa lựa chọn',
  'editor.ai.loading': 'AI đang xử lý...',
  'editor.ai.askAI': 'Hỏi AI',
  'editor.ai.askAI.placeholder': 'Nhập câu hỏi...',
  'editor.ai.improve': 'Cải thiện văn bản',
  'editor.ai.fixSpelling': 'Sửa chính tả và ngữ pháp',
  'editor.ai.makeShorter': 'Rút gọn',
  'editor.ai.makeLonger': 'Mở rộng',
  'editor.ai.simplify': 'Đơn giản hóa',
  'editor.ai.emojify': 'Thêm biểu tượng',
  'editor.ai.tldr': 'Tóm tắt',
  'editor.ai.translate': 'Dịch',
  'editor.ai.completeSentence': 'Hoàn thành câu',
  'editor.ai.adjustTone': 'Điều chỉnh giọng điệu',
  'editor.ai.tone.professional': 'Chuyên nghiệp',
  'editor.ai.tone.casual': 'Thân mật',
  'editor.ai.tone.straightforward': 'Trực tiếp',
  'editor.ai.tone.confident': 'Tự tin',
  'editor.ai.tone.friendly': 'Thân thiện',
  'editor.ai.language.english': 'Tiếng Anh',
  'editor.ai.language.chinese': 'Tiếng Trung',
  'editor.ai.language.spanish': 'Tiếng Tây Ban Nha',
  'editor.ai.language.french': 'Tiếng Pháp',
  'editor.ai.language.german': 'Tiếng Đức',
  'editor.ai.language.japanese': 'Tiếng Nhật',
  'editor.ai.language.korean': 'Tiếng Hàn',
  'editor.ai.language.portuguese': 'Tiếng Bồ Đào Nha',
  'editor.ai.language.russian': 'Tiếng Nga',
  'editor.ai.language.arabic': 'Tiếng Ả Rập',
};
