const locale = {
  ...
  'editor.ai.tooltip': 'AI Asszisztens',
  'editor.ai.editSelection': 'Kijelölés szerkesztése',
  'editor.ai.loading': 'AI feldolgozás...',
  'editor.ai.askAI': 'Kérdezd az AI-t',
  'editor.ai.askAI.placeholder': 'Írd be a kérdésed...',
  'editor.ai.improve': 'Írás javítása',
  'editor.ai.fixSpelling': 'Helyesírás és nyelvtan javítása',
  'editor.ai.makeShorter': 'Rövidítés',
  'editor.ai.makeLonger': 'Bővítés',
  'editor.ai.simplify': 'Egyszerűsítés',
  'editor.ai.emojify': 'Emojik hozzáadása',
  'editor.ai.tldr': 'Összefoglalás',
  'editor.ai.translate': 'Fordítás',
  'editor.ai.completeSentence': 'Mondat befejezése',
  'editor.ai.adjustTone': 'Hangnem módosítása',
  'editor.ai.tone.professional': 'Professzionális',
  'editor.ai.tone.casual': 'Közvetlen',
  'editor.ai.tone.straightforward': 'Egyenes',
  'editor.ai.tone.confident': 'Magabiztos',
  'editor.ai.tone.friendly': 'Barátságos',
  'editor.ai.language.english': 'Angol',
  'editor.ai.language.chinese': 'Kínai',
  'editor.ai.language.spanish': 'Spanyol',
  'editor.ai.language.french': 'Francia',
  'editor.ai.language.german': 'Német',
  'editor.ai.language.japanese': 'Japán',
  'editor.ai.language.korean': 'Koreai',
  'editor.ai.language.portuguese': 'Portugál',
  'editor.ai.language.russian': 'Orosz',
  'editor.ai.language.arabic': 'Arab',
};
