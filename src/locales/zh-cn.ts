const locale = {
  ...
  'editor.ai.tooltip': 'AI 助手',
  'editor.ai.editSelection': '编辑选中内容',
  'editor.ai.loading': 'AI 处理中...',
  'editor.ai.askAI': '询问 AI',
  'editor.ai.askAI.placeholder': '输入问题...',
  'editor.ai.improve': '改进写作',
  'editor.ai.fixSpelling': '修正拼写和语法',
  'editor.ai.makeShorter': '精简内容',
  'editor.ai.makeLonger': '扩展内容',
  'editor.ai.simplify': '简化语言',
  'editor.ai.emojify': '添加表情',
  'editor.ai.tldr': '总结要点',
  'editor.ai.translate': '翻译',
  'editor.ai.completeSentence': '补全句子',
  'editor.ai.adjustTone': '调整语气',
  'editor.ai.tone.professional': '专业',
  'editor.ai.tone.casual': '休闲',
  'editor.ai.tone.straightforward': '直接',
  'editor.ai.tone.confident': '自信',
  'editor.ai.tone.friendly': '友好',
  'editor.ai.language.english': '英语',
  'editor.ai.language.chinese': '中文',
  'editor.ai.language.spanish': '西班牙语',
  'editor.ai.language.french': '法语',
  'editor.ai.language.german': '德语',
  'editor.ai.language.japanese': '日语',
  'editor.ai.language.korean': '韩语',
  'editor.ai.language.portuguese': '葡萄牙语',
  'editor.ai.language.russian': '俄语',
  'editor.ai.language.arabic': '阿拉伯语',
};
