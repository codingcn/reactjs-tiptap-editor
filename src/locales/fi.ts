const locale = {
  ...
  'editor.ai.tooltip': 'AI-avustaja',
  'editor.ai.editSelection': 'Muokkaa valintaa',
  'editor.ai.loading': 'AI käsittelee...',
  'editor.ai.askAI': 'Kysy AI:lta',
  'editor.ai.askAI.placeholder': 'Kirjoita kysymyksesi...',
  'editor.ai.improve': 'Paranna kirjoitusta',
  'editor.ai.fixSpelling': 'Korjaa oikeinkirjoitus ja kielioppi',
  'editor.ai.makeShorter': 'Lyhennä',
  'editor.ai.makeLonger': 'Laajenna',
  'editor.ai.simplify': 'Yksinkertaista',
  'editor.ai.emojify': 'Lisää emojit',
  'editor.ai.tldr': 'Tiivistelmä',
  'editor.ai.translate': 'Käännä',
  'editor.ai.completeSentence': 'Täydennä lause',
  'editor.ai.adjustTone': 'Säädä sävyä',
  'editor.ai.tone.professional': 'Ammattimainen',
  'editor.ai.tone.casual': 'Rento',
  'editor.ai.tone.straightforward': 'Suora',
  'editor.ai.tone.confident': 'Itsevarma',
  'editor.ai.tone.friendly': 'Ystävällinen',
  'editor.ai.language.english': 'Englanti',
  'editor.ai.language.chinese': 'Kiina',
  'editor.ai.language.spanish': 'Espanja',
  'editor.ai.language.french': 'Ranska',
  'editor.ai.language.german': 'Saksa',
  'editor.ai.language.japanese': 'Japani',
  'editor.ai.language.korean': 'Korea',
  'editor.ai.language.portuguese': 'Portugali',
  'editor.ai.language.russian': 'Venäjä',
  'editor.ai.language.arabic': 'Arabia',
};
