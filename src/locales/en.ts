const locale = {
  ...
  'editor.ai.tooltip': 'AI Assistant',
  'editor.ai.editSelection': 'Edit Selection',
  'editor.ai.loading': 'AI Processing...',
  'editor.ai.askAI': 'Ask AI',
  'editor.ai.askAI.placeholder': 'Enter your question...',
  'editor.ai.improve': 'Improve Writing',
  'editor.ai.fixSpelling': 'Fix Spelling & Grammar',
  'editor.ai.makeShorter': 'Make Shorter',
  'editor.ai.makeLonger': 'Make Longer',
  'editor.ai.simplify': 'Simplify Language',
  'editor.ai.emojify': 'Add Emojis',
  'editor.ai.tldr': 'TL;DR',
  'editor.ai.translate': 'Translate',
  'editor.ai.completeSentence': 'Complete Sentence',
  'editor.ai.adjustTone': 'Adjust Tone',
  'editor.ai.tone.professional': 'Professional',
  'editor.ai.tone.casual': 'Casual',
  'editor.ai.tone.straightforward': 'Straightforward',
  'editor.ai.tone.confident': 'Confident',
  'editor.ai.tone.friendly': 'Friendly',
  'editor.ai.language.english': 'English',
  'editor.ai.language.chinese': 'Chinese',
  'editor.ai.language.spanish': 'Spanish',
  'editor.ai.language.french': 'French',
  'editor.ai.language.german': 'German',
  'editor.ai.language.japanese': 'Japanese',
  'editor.ai.language.korean': 'Korean',
  'editor.ai.language.portuguese': 'Portuguese',
  'editor.ai.language.russian': 'Russian',
  'editor.ai.language.arabic': 'Arabic',
};
