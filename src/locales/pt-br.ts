const locale = {
  ...
  'editor.ai.tooltip': 'Assistente de IA',
  'editor.ai.editSelection': 'Editar seleção',
  'editor.ai.loading': 'IA processando...',
  'editor.ai.askAI': 'Perguntar à IA',
  'editor.ai.askAI.placeholder': 'Digite sua pergunta...',
  'editor.ai.improve': 'Melhorar escrita',
  'editor.ai.fixSpelling': 'Corrigir ortografia e gramática',
  'editor.ai.makeShorter': 'Encurtar',
  'editor.ai.makeLonger': 'Expandir',
  'editor.ai.simplify': 'Simplificar',
  'editor.ai.emojify': 'Adicionar emojis',
  'editor.ai.tldr': 'Resumir',
  'editor.ai.translate': 'Traduzir',
  'editor.ai.completeSentence': 'Completar frase',
  'editor.ai.adjustTone': 'Ajustar tom',
  'editor.ai.tone.professional': 'Profissional',
  'editor.ai.tone.casual': 'Casual',
  'editor.ai.tone.straightforward': 'Direto',
  'editor.ai.tone.confident': 'Confiante',
  'editor.ai.tone.friendly': 'Amigável',
  'editor.ai.language.english': 'Inglês',
  'editor.ai.language.chinese': 'Chinês',
  'editor.ai.language.spanish': 'Espanhol',
  'editor.ai.language.french': 'Francês',
  'editor.ai.language.german': 'Alemão',
  'editor.ai.language.japanese': 'Japonês',
  'editor.ai.language.korean': 'Coreano',
  'editor.ai.language.portuguese': 'Português',
  'editor.ai.language.russian': 'Russo',
  'editor.ai.language.arabic': 'Árabe',
};
